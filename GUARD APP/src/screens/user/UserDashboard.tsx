...
import { Manual_Entry } from '@/components/visitors/Manual_Entry';
...
export const UserDashboard = () => {
 ...
 const dashboardCards = [
    ...
    { image: VisitorImg, title: 'Scan QR' },
    // { image: NoticeBoardImg, title: 'Notice Board' },
    // { image: PaymentImg, title: 'Code' },
    { image: BookAmenitiesImg, title: 'Manual Entry' },
  ...
  const renderContent = () => {
    ...
    if (activeSection === 'Manual Entry') {
      return (
        <Manual_Entry setActiveSection={setActiveSection}/>
      )
    }
